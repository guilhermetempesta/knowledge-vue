<template>
  <div class="user-admin">
    <b-form>
      ...
      <b-row>
        <b-col md="3" sm="6">
          <b-form-group label="Nome:" label-for="user-first-name">
        ...
        <b-col md="3" sm="6">
          <b-form-group label="Sobrenome:" label-for="user-last-name">
  ...
  data: function() {
    return {
      ...
      fields: [
        ...
        { key: 'role', label: 'Administrador', sortable: true ,
          formatter: value => (value==='admin') ? 'Sim' : 'Não' },
