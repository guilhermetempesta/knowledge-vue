    ...
    <b-form>
      ...
      <b-form-group v-if="mode!='remove'" 
        ...
        <b-form-select id="article-categoryId"
          :options="categories" v-model="article.category.id" />
      </b-form-group> 
      <b-form-group  v-if="mode!='remove'"  
        label="Autor:" label-for="article-userId">
        <b-form-select id="article-userId"
          :options="users" v-model="article.user.id" />
      </b-form-group> 
      <b-form-group  v-if="mode!='remove'" 
...
export default {  
  ...
  methods: {
    ...
    save() {
      this.article.categoryId = this.article.category.id
      this.article.userId = this.article.user.id      
